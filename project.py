...
class InputText:
    ...
    def events(self, event):
        ...
        if event.type == pygame.KEYDOWN and self.run_text:
            ...
            self.text_surf = pygame.font.Font(None, 32).render(self.login_t, 1, pygame.Color('lightblue'))
    ...
    def __init__(self, login):
        ...
        while run_nolog:
            ...
            if run_nolog:
                screen.fill((30, 30, 30))
                for i in range(3):
                    pygame.draw.rect(screen, pygame.Color("blue"), (160, 160 + i * 70, 290, 53), 3)
...
def music():
    pygame.init()
    music_sp = ["music/melody_1.mp3", "music/melody_2.mp3", "music/melody_3.mp3", "music/melody_4.mp3"]
